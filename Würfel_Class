...
public class Wuerfel
{
     ...
     */
    public int zufallsZahlAusgaben()
    {
        //erstellt eine Zufällige Zahl zwischen 1 und 6//
        int pMaximum = 6;
        Random zufallsAugenAnzahl = new Random();
        punkte = zufallsAugenAnzahl.nextInt(pMaximum)+1; // zufalls Zahl + 1, da man von 0 anfängt zu zählen
        return punkte; 
    }
